...
async function quotationRoutes(fastify: FastifyInstance) {
  fastify.post('/', qh.createQuotationHandler)
  fastify.get('/',qh.getAllQuotationsHandler)
  fastify.put('/:id', qh.updateQuotationHandler)
  fastify.get('/:id', qh.getQuotationByIdHandler)
  fastify.delete('/:id', qh.deleteQuotationHandler)
  fastify.post('/associate/:id', qh.associateProductHandler)
  fastify.get('/user/:user_id', qh.findQuotationsByUserIdHandler)
  fastify.post('/demande', qh.demandeQuotationHandler)
}
